    ...
    private class DownloadUpdatedVersion extends AsyncTask<String, Integer, Boolean> {
        ...
        protected void onProgressUpdate(Integer... progress) {
            ...
            if (updatedProgress != null) {
                ...
                if (updatedProgress > 99){
                    msg = "Concluíndo o download... ";
                } else{
                    msg = "Baixando... "+updatedProgress;
                }
            }
        ...
        protected void onPostExecute(Boolean result) {
            ...
            if (result != null && result) {
                Toast.makeText(context, "Instale o aplicativo atualizado.", Toast.LENGTH_SHORT).show();
            } else {
                Toast.makeText(context, "Por favor, tente novamente mais tarde", Toast.LENGTH_SHORT).show();
            }
        }
